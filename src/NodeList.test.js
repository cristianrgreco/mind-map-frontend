...
describe("NodeList", () => {
  ...
  describe("#addNode", () => {
    ...
    it("should add a new node with a parent when another node is selected", () => {
      const setup = nodeList.addNode(100, 100).setIsNew("id-1", false);
  ...
  describe("#removeNode", () => {
    ...
    it("should also remove orphaned nodes", () => {
      const setup = nodeList.addNode(100, 100).setIsNew("id-1", false).addNode(100, 100).setIsNew("id-2", false);

      const result = setup.setIsSelected("id-2").addNode(100, 100).setIsNew("id-3", false).removeNode("id-2");
  ...
  describe("#removeEmptyNodes", () => {
    it("should remove all empty nodes", () => {
      const setup = nodeList.addNode(100, 100).setValue("id-1", "", 0, 0).addNode(200, 200).setValue("id-2", "", 0, 0);
  ...
  describe("#setIsSelected", () => {
    it("should set the isSelected of the node and set isNew of other nodes to false", () => {
      const setup = nodeList.addNode(100, 100).setIsNew("id-1", true).addNode(100, 100);
    ...
    it("should not add to selectedNodes if an already selected node is selected", () => {
      const setup = nodeList.addNode(100, 100).setIsNew("id-1", false).addNode(100, 100);

      const result = setup.setIsSelected("id-2").setIsSelected("id-2");
